# PyPNM / MultiCapture / OfdmaPreEqualization / OfdmaPreEqualization-Analysis-MinAvgMax

## Source Files

- HTML/script: `visual/PyPNM/MultiCapture/OfdmaPreEqualization/OfdmaPreEqualization-Analysis-MinAvgMax.html`
- JSON sample: `visual/PyPNM/MultiCapture/OfdmaPreEqualization/OfdmaPreEqualization-Analysis-MinAvgMax.json`

## Preview

<iframe src="../../../../visual-previews/MultiCapture/OfdmaPreEqualization/OfdmaPreEqualization-Analysis-MinAvgMax.html" style="width:100%;height:900px;border:1px solid #ccc;border-radius:6px;"></iframe>
...
var template = `
<canvas id="analysisChart" height="80"></canvas>
...
<script>
    ...
    var analysisChart = new Chart(ctx, {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Analysis Results - Min/Avg/Max',
                fontSize: 16
            },
            scales: {
                xAxes: [{
    ...
    pm.getData(function (err, value) {
        ...
        if (responseData && responseData.data && responseData.data.results && responseData.data.results.length > 0) {
            var result = responseData.data.results[0];
            
            analysisChart.data.labels = result.frequency;
            analysisChart.data.datasets[0].data = result.min;
            analysisChart.data.datasets[1].data = result.avg;
            analysisChart.data.datasets[2].data = result.max;
