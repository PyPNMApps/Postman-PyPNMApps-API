# PyPNM / DOCSIS-3.1 / DiplexConfiguration

## Source Files

- HTML/script: `visual/PyPNM/DOCSIS-3.1/DiplexConfiguration.html`
- JSON sample: `visual/PyPNM/DOCSIS-3.1/DiplexConfiguration.json`
