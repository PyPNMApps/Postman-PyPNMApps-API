# PyPNM-CMTS / ServingGroup / Opertions / Get / status

## Source Files

- HTML/script: `visual/PyPNM-CMTS/ServingGroup/Opertions/Get/status.html`
- JSON sample: `visual/PyPNM-CMTS/ServingGroup/Opertions/Get/status.json`

## Preview

<iframe src="../../../../../../visual-previews/PyPNM-CMTS/ServingGroup/Opertions/Get/status.html" style="width:100%;height:900px;border:1px solid #ccc;border-radius:6px;"></iframe>
